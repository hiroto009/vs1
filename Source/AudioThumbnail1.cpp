...
class AudioThumbnail1 : public AudioAppComponent,
...
private:
	...
	JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(AudioThumbnail1)
};


Component* createAudioThumbnail1() { return new AudioThumbnail1(); }
