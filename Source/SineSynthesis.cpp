...
class SineSynthesis   : public AudioAppComponent,
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (SineSynthesis)
};

Component* createSineSynthesis()     { return new SineSynthesis(); }
